...
class BaseConfig():
    @staticmethod
    def print_info(x):
        logger.info('Trainer.TARGET_NETWORK_UPDATE_FREQUENCY : ' +
                    str(x.Trainer.TARGET_NETWORK_UPDATE_FREQUENCY))
        logger.info('Trainer.MODEL_PERSISTENCE_UPDATE_FREQUENCY : ' +
                    str(x.Trainer.MODEL_PERSISTENCE_UPDATE_FREQUENCY))
        logger.info('Trainer.LOG_FILE_SAVING_FREQUENCY : ' +
                    str(x.Trainer.LOG_FILE_SAVING_FREQUENCY))
        logger.info('Trainer.NUM_OF_ROUND : ' + str(x.Trainer.NUM_OF_ROUND))
        logger.info('Trainer.NUM_OF_ITERATION : ' +
                    str(x.Trainer.NUM_OF_ITERATION))

        logger.info('Stats.TRAINING_UPDATE_FREQUENCY  : ' +
                    str(x.Stats.TRAINING_UPDATE_FREQUENCY))
        logger.info('Stats.RUN_UPDATE_FREQUENCY  : ' +
                    str(x.Stats.RUN_UPDATE_FREQUENCY))
